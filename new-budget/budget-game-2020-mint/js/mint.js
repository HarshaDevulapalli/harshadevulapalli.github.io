...
function go() { var t = 692992,
    ...
    function u(t, e) { t.forEach(function(t, a) { $(".budget-items-" + e).append("<div data-item-name='" + t.item_name + "' data-reaction='" + t.reaction + "' data-reaction-amount='" + t.reaction_amount + "' data-allocation='" + t.allocation + "' data-type='" + e + "' data-index='" + a + "' class='budget-item budget-item-" + a + "'></div>"); var n = ".budget-items-" + e + " .budget-item-" + a;
            ...
            $(n).append("<div class='budget-item-allocation'><p class='rupees'>Rupees</p><p class='number" + (i.length < 7 ? "" : i.length >= 7 && i.length < 10 ? " number-sm" : " number-xsm") + "'>" + i + "</p><p class='crore'>crore</p><div class='budget-item-allocation-whitespace'></div></div>"); var o = { cut: { "option_.25": "Cut by a quarter", "option_.5": "Cut in half", option_1: "Eliminate" }, spend: { "option_.5": "Raise by 50%", option_1: "Double", option_3: "Quadruple" } };
